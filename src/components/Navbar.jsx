...
const Navbar = () => {
  ...
  return (
      ...
      <div className='links'>
        <Link  className='all-links' activeClass='active' spy={true} smooth={true} offset={-65}  duration={400} to="home">Home</Link>
      ...
      <img  id='menu-icon' src={isOpen? cross : menu} alt="menu" onClick={() =>  setisOpen(!isOpen)}/>
      <div className={ isOpen?'links-menu':'links-off'}>
        ...
        <Link className='all-links' activeClass='active' spy={true} smooth={true} offset={-68}  duration={400} to="about" onClick={()=>setisOpen (false)}>About</Link>
        ...
        <Link className='all-links' activeClass='active' spy={true} smooth={true} offset={-87}  duration={400} to="contact" onClick={()=>setisOpen (false)}>Contact</Link>
      </div>
